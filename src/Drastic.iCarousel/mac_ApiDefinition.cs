...
namespace Drastic.iCarousel
{
	...
	interface iCarousel
	{
		...
		NSView[] IndexesForVisibleItems { get; }
		...
		[return: NullAllowed]
		NSView ItemViewAtPoint (CGPoint point);
	...
	interface iCarouselDataSource
	{
		...
		NSView CarouselWithView (iCarousel carousel, nint index, [NullAllowed] NSView view);
		...
		NSView CarouselWithPlaceholderView (iCarousel carousel, nint index, [NullAllowed] NSView view);
	}
	...
	interface iCarouselDelegate
	{
		...
		bool CarouselShouldSelectItemAtIndex (iCarousel carousel, nint index);
		...
		void CarouselDidSelectItemAtIndex (iCarousel carousel, nint index);
		...
		CATransform3D Carousel (iCarousel carousel, nfloat offset, CATransform3D transform);
		...
		nfloat Carousel (iCarousel carousel, iCarouselOption option, nfloat value);
	}
}