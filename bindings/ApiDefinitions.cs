...
namespace Drastic.iCarousel
{
	...
	interface iCarouselDataSource
	{
		...
		NSView Carousel (iCarousel carousel, nint index, [NullAllowed] NSView view);
	...
	interface iCarouselDelegate
	{
		...
		bool Carousel (iCarousel carousel, nint index);
		...
		void Carousel (iCarousel carousel, nint index);
