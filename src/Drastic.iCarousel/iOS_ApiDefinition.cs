...
namespace Drastic.iCarousel
{
	...
	interface iCarousel
	{
        ...
        UIView[] IndexesForVisibleItems { get; }
	...
	interface iCarouselDataSource
	{
		...
		UIView CarouselWithView (iCarousel carousel, nint index, [NullAllowed] UIView view);
		...
		UIView CarouselWithPlaceholderView (iCarousel carousel, nint index, [NullAllowed] UIView view);
	}
